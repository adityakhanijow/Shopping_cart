...
db.sync({force:true}).then(()=>{
    console.log("sync success");
     Vendor.create({name:"OPPO"});
     Vendor.create({name:"VIVO"})
     Vendor.create({name:"POCCO"})
     Product.create({name:"OPPO",price:50,VendorId:1})
     Product.create({name:"Redmi note 7 pro",price:100,VendorId:1})
     User.create({name:"Aditya"})
     User.create({name:"Naman"})
     User.create({name:"Vaibhav"})
     User.create({name:"Mohit"})
     User.create({name:"Swastik"}) 
